...
function Home() {
  ...
  return <><Header /><main id="main-content">
    <section id="top" className="hero" aria-labelledby="hero-title">
      ...
      <div className="hero-note"><span>Southern Illinois University Edwardsville</span></div><div className="hero-scroll" aria-hidden="true"><span>Scroll to explore</span><span className="scroll-line" /></div>
    </section>

    <div className="identity-strip" aria-label="Beta Alpha Psi values"><div className="identity-track"><div className="identity-sequence"><div className="identity-item"><span>ΒΑΨ</span><b>Scholarship</b></div><div className="identity-item"><span>ΒΑΨ</span><b>Professionalism</b></div><div className="identity-item"><span>ΒΑΨ</span><b>Service</b></div><div className="identity-item"><span>ΒΑΨ</span><b>Integrity</b></div></div><div className="identity-sequence" aria-hidden="true"><div className="identity-item"><span>ΒΑΨ</span><b>Scholarship</b></div><div className="identity-item"><span>ΒΑΨ</span><b>Professionalism</b></div><div className="identity-item"><span>ΒΑΨ</span><b>Service</b></div><div className="identity-item"><span>ΒΑΨ</span><b>Integrity</b></div></div></div></div>
